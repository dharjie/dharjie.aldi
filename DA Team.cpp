    ...
    if(p==1)
        {
            ...
            else
            {
                ...
                {
                    cout<<"Terima kasih telah mengunjungi DA TEAM"<<endl;
                }
...
void beli()
{
    ...
    cout<<"         Harga                : Rp. "<<harga<<".000.000,-"<<endl;
    cout<<"         Jumlah Pembelian     : "<<jp<<endl;
    cout<<"         Total Harga          : Rp. "<<jumlah<<".000.000,-"<<endl<<endl<<endl;
    cout<<"-=-=-=-=-=-=-=--=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=--=-=-=-=-=-=-=-"<<endl<<endl;
